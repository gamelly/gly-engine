...
function test_decorator_prefix3()
    ...
    luaunit.assertEquals(result, {1, 2, 3, 4, 5, 6, 7, 8, 9})
end
...
function test_decorator_prefix2()
    ...
    luaunit.assertEquals(result, {1, 2, 3, 4, 5, 6, 7, 8})
end
...
function test_decorator_prefix1()
    ...
    luaunit.assertEquals(result, {1, 2, 3, 4, 5, 6, 7})
end
...
function test_decorator_offset_xy2()
    ...
    luaunit.assertEquals(result, {1, 12, 23, 4, 5, 6})
end
...
function test_decorator_offset_xyxy1()
    ...
    local result = {decorated_func(1, 2, 3, 4, 5, 6)}
    luaunit.assertEquals(result, {11, 22, 13, 24, 5, 6})
end
...
function test_decorator_offset_xy1()
    ...
    local result = {decorated_func(1, 2, 3, 4, 5, 6)}
    luaunit.assertEquals(result, {11, 22, 3, 4, 5, 6})
end
